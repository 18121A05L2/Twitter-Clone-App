 ...
 * @dev If this exceeds the Limit of 24kb for Twitter contract we will implement a diamond proxy pattern contract 
 * - https://eips.ethereum.org/EIPS/eip-2535#reference-implementation
 */
